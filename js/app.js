...
var showAnswerers = function(answerers) {
	...
	var tagElem = result.find('.user');
	tagElem.text(answerers.user.display_name);
    
    // Set the profile_image properties in result
	var tagPhoto = result.find('.user_pic img');
	tagPhoto.attr('src', answerers.user.profile_image);
	

	// set the user.score for score property in result
...
function getAnswerers(answered){
...
$(document).ready( function() {
	...
	$('.inspiration-getter').submit( function(e){
		...
		// zero out results if previous search has run
		$('.results').html('');
		// get the value of the answered the user submitted
